...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1_register.setText("Click here to login");
    ...
    private void jButton_Register_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Register_ActionPerformed
        ...
        String query = "INSERT INTO `user`(`u_uname`,`u_fname`, `u_lname`, `u_pass`, `u_address`, `admin`, `SBD`) VALUES (?,?,?,?,?,?,?)";
        String sbdQuery = "CALL DanhSBD()";
        try {
            ...
            if(ps.executeUpdate() > 0)
            {
                ...
                PreparedStatement ps1 = MyConnection.getConnection().prepareStatement(sbdQuery);
                ps1.executeQuery();
            }          
    ...
    public boolean checkUsername(String username)
    {
        ...
        String query = "SELECT `u_fname` FROM `user` WHERE `u_uname` =?";
